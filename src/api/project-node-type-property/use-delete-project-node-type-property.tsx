...
export const useDeleteProjectNodeTypeProperty = (nodeTypePropertyId = '', options?: UseQueryOptions) => {
  ...
  const mutation = useMutation({ mutationFn: () => client.delete(URL_PROJECT_NODE_TYPE_PROPERTY_DELETE.replace(':id', nodeTypePropertyId)), onSuccess: (data, variables, context) => {
