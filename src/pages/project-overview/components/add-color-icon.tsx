...
export const AddColorIcon = () => {
    ...
    return <><Button type="dashed" onClick={handleOpenModal} color={Form.useWatch('color')}>
    ...
    >
        <VerticalSpace size={32}>
            <VerticalSpace size={20}>
                ...
                <SelectIcon />
                <ButtonComponent block type="primary" onClick={handleSave}>SAVE</ButtonComponent>
                <ButtonComponent block type="text" onClick={handleCancel}>Cancel</ButtonComponent>
            </VerticalSpace>
