...
export const ProjectType = () => {
    return <FormItem name="privacy" initialValue="public">
    <RadioGroup buttonStyle="solid">
        <RadioButton value="public"><Space size={30}><Globe className="icon" /><Text>Public</Text></Space></RadioButton>
        <RadioButton value="private"><Space size={30}><Users className="icon" /><Text>Private</Text></Space></RadioButton>
    </RadioGroup>
  </FormItem> 
}