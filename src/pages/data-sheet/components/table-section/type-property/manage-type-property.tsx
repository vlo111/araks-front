...
export const ManageTypeProperty = React.memo(({ children, propertyId, isDefault, ...props }: Props) => {
  const {
  ...
  return (
    <>
      <ManageNodeTypePopover
        content={<TypePropertyMenu isDefault={isDefault} propertyId={propertyId} />}
        open={isOpened}
        trigger="click"
