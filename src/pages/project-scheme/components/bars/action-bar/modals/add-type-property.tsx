...
//   PortName = 'attrs/portNameLabel/text',
//   PortDataType = 'attrs/portTypeLabel/text',
// }
//
// interface IPosition {
//   left: number;
...
//   //   if (addPortModal !== undefined) {
//   //     const { node, portId, isUpdate } = addPortModal;
//   //
//   //     if (isUpdate as boolean) {
//   //       node.portProp(portId, Path.PortName, propertyName);
//   //       node.portProp(portId, Path.PortDataType, propertyDataType);
//   //     } else {
...
//   // }, [addPortModal]);
//
//   // if (typeof addPortModal !== 'boolean' && !addPortModal) return null;
//
//   return (
//       <div>a</div>
//     // <>
